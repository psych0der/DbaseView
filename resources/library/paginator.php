...
class Paginator {
	...
	function display_items_per_page()
	{
		...
		$items = '';
		$ipp_array = array(10,25,40,100,'All');
		...
		<select class=\"select\" onchange=\"window.location='$_SERVER[PHP_SELF]?page=1&ipp='this[this.selectedIndex].value;return false\">$items</select>\n";
